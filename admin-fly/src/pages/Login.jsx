...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        let url = import.meta.env.VITE_BASE_API + "/login/admin"; // Ensure you have the correct base URL
        ...
        axios({
            ...
            .then((res) => {
                ...
                if (res.data.success) {
                    navigate("/foods"); // Redirect to menus page on successful login
                }
            })
            .catch((err) => {
                toast.error("Sorry ! You are not authorized for this.")
